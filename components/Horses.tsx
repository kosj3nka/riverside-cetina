    ...
    <section id="horses" className="mx-auto max-w-6xl px-6 py-24 sm:py-32">
      <Reveal className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-4 font-body text-lg text-ink/80">
          Gentle, well-trained, and used to riders of every experience level
          — from nervous first-timers to kids on their first trail.
        </p>
      </Reveal>
      ...
      <Reveal delay={0.2} className="mt-6">
        <figure className="relative mx-auto aspect-video max-w-2xl overflow-hidden rounded-2xl">
          <video
            autoPlay
            muted
            loop
